...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1638: (x0,x1) => x0.replaceChildren(x1),
      _1639: (x0,x1) => x0.append(x1),
      _1640: x0 => x0.click(),
      _1642: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1643: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      ...
      _1676: x0 => ({name: x0}),
      _1677: (x0,x1) => x0.query(x1),
      _1678: x0 => ({audio: x0}),
      _1679: (x0,x1) => x0.getUserMedia(x1),
      _1680: x0 => x0.getAudioTracks(),
      _1681: x0 => x0.stop(),
      _1682: x0 => ({video: x0}),
      _1683: x0 => x0.getVideoTracks(),
      _1684: x0 => x0.stop(),
      ...
      _1687: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      _1691: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1692: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1693: x0 => globalThis.firebase_core.getApp(x0),
      _1694: () => globalThis.firebase_core.getApp(),
      _1696: (x0,x1) => ({next: x0,error: x1}),
      _1698: x0 => globalThis.firebase_messaging.getMessaging(x0),
      _1700: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      _1702: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      _1706: x0 => x0.title,
      _1707: x0 => x0.body,
      _1708: x0 => x0.image,
      _1709: x0 => x0.messageId,
      _1710: x0 => x0.collapseKey,
      _1711: x0 => x0.fcmOptions,
      _1712: x0 => x0.notification,
      _1713: x0 => x0.data,
      _1714: x0 => x0.from,
      _1715: x0 => x0.analyticsLabel,
      _1716: x0 => x0.link,
      ...
      _1721: () => globalThis.firebase_core.SDK_VERSION,
      _1728: x0 => x0.apiKey,
      _1730: x0 => x0.authDomain,
      _1732: x0 => x0.databaseURL,
      _1734: x0 => x0.projectId,
      _1736: x0 => x0.storageBucket,
      _1738: x0 => x0.messagingSenderId,
      _1740: x0 => x0.measurementId,
      _1742: x0 => x0.appId,
      _1744: x0 => x0.name,
      _1745: x0 => x0.options,
      _1746: (x0,x1) => x0.debug(x1),
      _1747: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1747(f,arguments.length,x0) }),
      _1748: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1748(f,arguments.length,x0,x1) }),
      _1749: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1750: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1751: (x0,x1) => x0.createScriptURL(x1),
      _1752: (x0,x1,x2) => x0.createScript(x1,x2),
      _1753: (x0,x1) => x0.appendChild(x1),
      _1754: (x0,x1) => x0.appendChild(x1),
      _1755: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1755(f,arguments.length,x0) }),
      _1768: x0 => new Array(x0),
      _1770: x0 => x0.length,
      _1772: (x0,x1) => x0[x1],
      _1773: (x0,x1,x2) => x0[x1] = x2,
      _1776: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1778: x0 => new Int8Array(x0),
      _1779: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1780: x0 => new Uint8Array(x0),
      _1788: x0 => new Int32Array(x0),
      _1790: x0 => new Uint32Array(x0),
      _1792: x0 => new Float32Array(x0),
      _1794: x0 => new Float64Array(x0),
      ...
      _1826: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1827: () => new TextDecoder("utf-8", {fatal: true}),
      _1828: () => new TextDecoder("utf-8", {fatal: false}),
      _1829: x0 => new WeakRef(x0),
      _1830: x0 => x0.deref(),
      _1836: Date.now,
      _1838: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1839: s => {
      ...
      _1841: () => typeof dartUseDateNowForTicks !== "undefined",
      _1842: () => 1000 * performance.now(),
      _1843: () => Date.now(),
      _1844: () => {
      ...
      _1846: () => new WeakMap(),
      _1847: (map, o) => map.get(o),
      _1848: (map, o, v) => map.set(o, v),
      _1849: () => globalThis.WeakRef,
      _1860: s => JSON.stringify(s),
      _1861: s => printToConsole(s),
      _1862: a => a.join(''),
      _1863: (o, a, b) => o.replace(a, b),
      _1864: (o, p, r) => o.split(p).join(r),
      _1865: (s, t) => s.split(t),
      _1866: s => s.toLowerCase(),
      _1867: s => s.toUpperCase(),
      _1868: s => s.trim(),
      _1869: s => s.trimLeft(),
      _1870: s => s.trimRight(),
      _1872: (s, p, i) => s.indexOf(p, i),
      _1873: (s, p, i) => s.lastIndexOf(p, i),
      _1874: (s) => s.replace(/\$/g, "$$$$"),
      _1875: Object.is,
      _1876: s => s.toUpperCase(),
      ...
      _1885: (a, s) => a.join(s),
      _1886: (a, s, e) => a.slice(s, e),
      _1888: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1889: a => a.length,
      _1890: (a, l) => a.length = l,
      _1891: (a, i) => a[i],
      _1892: (a, i, v) => a[i] = v,
      ...
      _1904: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1905: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1906: (t, s) => t.set(s),
      _1908: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1910: o => o.buffer,
      _1911: o => o.byteOffset,
      _1912: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1913: (b, o) => new DataView(b, o),
      _1914: (b, o, l) => new DataView(b, o, l),
      _1915: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1916: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1917: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1918: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1919: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1920: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1921: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1922: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1923: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1924: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1925: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1926: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1929: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1930: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1931: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1932: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1933: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1934: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1947: () => new XMLHttpRequest(),
      _1948: (x0,x1,x2) => x0.open(x1,x2),
      _1949: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1954: x0 => x0.abort(),
      _1955: x0 => x0.send(),
      _1957: x0 => x0.getAllResponseHeaders(),
      ...
      _1968: () => Date.now(),
      _1984: () => new XMLHttpRequest(),
      _1986: () => new FileReader(),
      _1987: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _2006: (x0,x1) => x0.key(x1),
      _2007: (x0,x1) => x0.item(x1),
      _2008: x0 => x0.trustedTypes,
      ...
      _2066: l => arrayFromDartList(Int8Array, l),
      _2067: l => arrayFromDartList(Uint8Array, l),
      _2068: l => arrayFromDartList(Uint8ClampedArray, l),
      _2069: l => arrayFromDartList(Int16Array, l),
      _2070: l => arrayFromDartList(Uint16Array, l),
      _2071: l => arrayFromDartList(Int32Array, l),
      _2072: l => arrayFromDartList(Uint32Array, l),
      _2073: l => arrayFromDartList(Float32Array, l),
      _2074: l => arrayFromDartList(Float64Array, l),
      ...
      _2077: l => arrayFromDartList(Array, l),
      _2078: () => ({}),
      _2079: () => [],
      _2080: l => new Array(l),
      _2081: () => globalThis,
      ...
      _2126: Function.prototype.call.bind(Number.prototype.toString),
      _2127: (d, digits) => d.toFixed(digits),
      _2131: () => globalThis.document,
      _2155: x0 => x0.src,
      _2156: (x0,x1) => x0.src = x1,
      _2157: x0 => x0.naturalWidth,
      _2158: x0 => x0.naturalHeight,
      _2183: x0 => x0.status,
      _2184: (x0,x1) => x0.responseType = x1,
      _2186: x0 => x0.response,
      _2234: x0 => x0.readyState,
      _2236: (x0,x1) => x0.timeout = x1,
      _2238: (x0,x1) => x0.withCredentials = x1,
      _2239: x0 => x0.upload,
      _2240: x0 => x0.responseURL,
      _2241: x0 => x0.status,
      _2242: x0 => x0.statusText,
      _2244: (x0,x1) => x0.responseType = x1,
      _2245: x0 => x0.response,
      _2259: x0 => x0.loaded,
      _2260: x0 => x0.total,
      _2338: (x0,x1) => x0.oncancel = x1,
      _2344: (x0,x1) => x0.onchange = x1,
      _2384: (x0,x1) => x0.onerror = x1,
      _3257: (x0,x1) => x0.accept = x1,
      _3271: x0 => x0.files,
      _3297: (x0,x1) => x0.multiple = x1,
      _3315: (x0,x1) => x0.type = x1,
      _3572: (x0,x1) => x0.type = x1,
      _3580: (x0,x1) => x0.crossOrigin = x1,
      _3582: (x0,x1) => x0.text = x1,
      _4056: () => globalThis.window,
      _4120: x0 => x0.navigator,
      _4382: x0 => x0.trustedTypes,
      _4384: x0 => x0.localStorage,
      _4492: x0 => x0.geolocation,
      _4495: x0 => x0.mediaDevices,
      _4497: x0 => x0.permissions,
      _4498: x0 => x0.maxTouchPoints,
      _4508: x0 => x0.platform,
      _4511: x0 => x0.userAgent,
      _4512: x0 => x0.vendor,
      _4731: x0 => x0.length,
      _6714: x0 => x0.type,
      _6715: x0 => x0.target,
      _6836: () => globalThis.document,
      _6929: x0 => x0.body,
      _6931: x0 => x0.head,
      _7280: (x0,x1) => x0.id = x1,
      _8849: x0 => x0.size,
      _8850: x0 => x0.type,
      _8857: x0 => x0.name,
      _8858: x0 => x0.lastModified,
      _8864: x0 => x0.length,
      _8875: x0 => x0.result,
      _9789: x0 => x0.state,
      _10195: x0 => x0.active,
      _13782: () => globalThis.console,
      _13811: () => globalThis.window.flutterCanvasKit,
      _13812: () => globalThis.window._flutter_skwasmInstance,
      _13813: x0 => x0.name,
