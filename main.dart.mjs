...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1672: (x0,x1) => x0.removeItem(x1),
      _1673: (x0,x1,x2) => x0.setItem(x1,x2),
      _1677: x0 => ({name: x0}),
      _1678: (x0,x1) => x0.query(x1),
      _1679: x0 => ({audio: x0}),
      _1680: (x0,x1) => x0.getUserMedia(x1),
      _1681: x0 => x0.getAudioTracks(),
      _1682: x0 => x0.stop(),
      _1683: x0 => ({video: x0}),
      ...
      _1688: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      _1692: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1693: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1694: x0 => globalThis.firebase_core.getApp(x0),
      _1695: () => globalThis.firebase_core.getApp(),
      _1697: (x0,x1) => ({next: x0,error: x1}),
      _1699: x0 => globalThis.firebase_messaging.getMessaging(x0),
      _1701: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      _1703: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      _1707: x0 => x0.title,
      _1708: x0 => x0.body,
      _1709: x0 => x0.image,
      _1710: x0 => x0.messageId,
      _1711: x0 => x0.collapseKey,
      _1712: x0 => x0.fcmOptions,
      _1713: x0 => x0.notification,
      _1714: x0 => x0.data,
      _1715: x0 => x0.from,
      _1716: x0 => x0.analyticsLabel,
      _1717: x0 => x0.link,
      ...
      _1722: () => globalThis.firebase_core.SDK_VERSION,
      _1729: x0 => x0.apiKey,
      _1731: x0 => x0.authDomain,
      _1733: x0 => x0.databaseURL,
      _1735: x0 => x0.projectId,
      _1737: x0 => x0.storageBucket,
      _1739: x0 => x0.messagingSenderId,
      _1741: x0 => x0.measurementId,
      _1743: x0 => x0.appId,
      _1745: x0 => x0.name,
      _1746: x0 => x0.options,
      _1747: (x0,x1) => x0.debug(x1),
      _1748: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1748(f,arguments.length,x0) }),
      _1749: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1749(f,arguments.length,x0,x1) }),
      _1750: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1751: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1752: (x0,x1) => x0.createScriptURL(x1),
      _1753: (x0,x1,x2) => x0.createScript(x1,x2),
      _1754: (x0,x1) => x0.appendChild(x1),
      _1755: (x0,x1) => x0.appendChild(x1),
      _1756: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1756(f,arguments.length,x0) }),
      _1769: x0 => new Array(x0),
      _1771: x0 => x0.length,
      _1773: (x0,x1) => x0[x1],
      _1774: (x0,x1,x2) => x0[x1] = x2,
      _1777: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1779: x0 => new Int8Array(x0),
      _1780: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1781: x0 => new Uint8Array(x0),
      _1789: x0 => new Int32Array(x0),
      _1791: x0 => new Uint32Array(x0),
      _1793: x0 => new Float32Array(x0),
      _1795: x0 => new Float64Array(x0),
      ...
      _1827: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1828: () => new TextDecoder("utf-8", {fatal: true}),
      _1829: () => new TextDecoder("utf-8", {fatal: false}),
      ...
      _1875: (s) => s.replace(/\$/g, "$$$$"),
      _1876: Object.is,
      _1877: s => s.toUpperCase(),
      _1878: s => s.toLowerCase(),
      _1879: (a, i) => a.push(i),
      _1882: (a, l) => a.length = l,
      _1883: a => a.pop(),
      _1884: (a, i) => a.splice(i, 1),
      _1886: (a, s) => a.join(s),
      _1887: (a, s, e) => a.slice(s, e),
      _1889: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1890: a => a.length,
      _1891: (a, l) => a.length = l,
      _1892: (a, i) => a[i],
      _1893: (a, i, v) => a[i] = v,
      ...
      _1955: x0 => x0.abort(),
      _1956: x0 => x0.send(),
      _1958: x0 => x0.getAllResponseHeaders(),
      _1959: (o, t) => o instanceof t,
      ...
      _1976: () => new AbortController(),
      _1977: x0 => x0.getReader(),
      _1978: x0 => x0.read(),
      _1979: x0 => x0.cancel(),
      _1985: () => new XMLHttpRequest(),
      _1987: () => new FileReader(),
      _1988: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _2007: (x0,x1) => x0.key(x1),
      _2008: (x0,x1) => x0.item(x1),
      _2009: x0 => x0.trustedTypes,
      _2011: (x0,x1) => x0.text = x1,
      _2027: (s, m) => {
        try {
      ...
      _2132: () => globalThis.document,
      _2156: x0 => x0.src,
      _2157: (x0,x1) => x0.src = x1,
      _2158: x0 => x0.naturalWidth,
      _2159: x0 => x0.naturalHeight,
      _2184: x0 => x0.status,
      _2185: (x0,x1) => x0.responseType = x1,
      _2187: x0 => x0.response,
      _2235: x0 => x0.readyState,
      _2237: (x0,x1) => x0.timeout = x1,
      _2239: (x0,x1) => x0.withCredentials = x1,
      _2240: x0 => x0.upload,
      _2241: x0 => x0.responseURL,
      _2242: x0 => x0.status,
      _2243: x0 => x0.statusText,
      _2245: (x0,x1) => x0.responseType = x1,
      _2246: x0 => x0.response,
      _2260: x0 => x0.loaded,
      _2261: x0 => x0.total,
      _2339: (x0,x1) => x0.oncancel = x1,
      _2345: (x0,x1) => x0.onchange = x1,
      _2385: (x0,x1) => x0.onerror = x1,
      _3258: (x0,x1) => x0.accept = x1,
      _3272: x0 => x0.files,
      _3298: (x0,x1) => x0.multiple = x1,
      _3316: (x0,x1) => x0.type = x1,
      _3573: (x0,x1) => x0.type = x1,
      _3581: (x0,x1) => x0.crossOrigin = x1,
      _3583: (x0,x1) => x0.text = x1,
      _4057: () => globalThis.window,
      _4121: x0 => x0.navigator,
      _4383: x0 => x0.trustedTypes,
      _4385: x0 => x0.localStorage,
      _4493: x0 => x0.geolocation,
      _4496: x0 => x0.mediaDevices,
      _4498: x0 => x0.permissions,
      _4499: x0 => x0.maxTouchPoints,
      _4509: x0 => x0.platform,
      ...
      _8851: x0 => x0.type,
      _8858: x0 => x0.name,
      _8859: x0 => x0.lastModified,
      _8865: x0 => x0.length,
      _8876: x0 => x0.result,
      _9385: x0 => x0.url,
      _9387: x0 => x0.status,
      _9389: x0 => x0.statusText,
      _9390: x0 => x0.headers,
      _9391: x0 => x0.body,
      _9790: x0 => x0.state,
      _10196: x0 => x0.active,
      _13783: () => globalThis.console,
      _13812: () => globalThis.window.flutterCanvasKit,
      _13813: () => globalThis.window._flutter_skwasmInstance,
      _13814: x0 => x0.name,
      _13815: x0 => x0.message,
      _13816: x0 => x0.code,
